...
class SoccerPitchConfiguration:
    width: int = 1300  # [cm]
    length: int = 2000  # [cm]
    penalty_box_width: int = 760  # [cm]
    penalty_box_length: int = 335  # [cm]
    goal_box_width: int = 340  # [cm]
    goal_box_length: int = 92  # [cm]
    centre_circle_radius: int = 150  # [cm]
    penalty_spot_distance: int = 180  # [cm]

    @property
    def vertices(self) -> List[Tuple[int, int]]:
        return [
            (0, 0),  # 1 left top corner
            ...
            (0, self.width),  # 6 left bottom corner
            ...
            (self.length, 0),  # 25 right top corner
            ...
            (self.length, self.width),  # 30 right bottom corner
