...
from utils import SoccerPitchConfiguration
...
def draw_points_on_pitch(
    ...
    Args:
        ...
        scale (float, optional): Scaling factor for the pitch dimensions.
            Defaults to 0.1.
        pitch (Optional[np.ndarray], optional): Existing pitch image to draw_utils points on.
...
def draw_paths_on_pitch(
    ...
    Args:
        ...
        scale (float, optional): Scaling factor for the pitch dimensions.
            Defaults to 0.1.
        pitch (Optional[np.ndarray], optional): Existing pitch image to draw_utils paths on.
            If None, a new pitch will be created. Defaults to None.
...
def draw_pitch_voronoi_diagram(
    ...
    Args:
        ...
        scale (float, optional): Scaling factor for the pitch dimensions.
            Defaults to 0.1.
        pitch (Optional[np.ndarray], optional): Existing pitch image to draw_utils the
